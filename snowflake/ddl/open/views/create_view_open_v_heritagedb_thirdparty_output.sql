...
CREATE VIEW IF NOT EXISTS open.v_heritagedb_thirdparty_output
AS
SELECT
...
,src:geo_match::SMALLINT AS GEO_MATCH
,src:pool_type::SMALLINT AS POOL_TYPE
...
,src
,dt
FROM stage.heritagedb_thirdparty_output;
