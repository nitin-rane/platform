...
create table if not exists stage.ga_hits_homegate_apps(
...
cluster by (dt)
comment='This table stores data that is extracted from a Google Big query source in JSON format. The data is for homegate apps. Google dataset ID number is 106414467'
;     
